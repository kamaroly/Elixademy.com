defmodule ElixademyWeb.AshForm do
  @moduledoc """
  ...
  `Elixademy.Members.Member` resource, such as `name`, `email`, etc., based on the resource’s
  ...
  - ElixademyWeb.CoreComponents (for input and button components)
  ...
  use Gettext, backend: ElixademyWeb.Gettext
  ...
  attr :current_user, Elixademy.Accounts.User, required: true
  ...
  def render(assigns) do
    ...
    <div class="m-4">
      <Phoenix.Component.form for={@form} phx-change="validate" phx-submit="save" phx-target={@myself}>
        ...
        <div>
          <ElixademyWeb.CoreComponents.input
        ...
        <ElixademyWeb.CoreComponents.button>
          Submit
        </ElixademyWeb.CoreComponents.button>
