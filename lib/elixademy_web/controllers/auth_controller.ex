defmodule ElixademyWeb.AuthController do
  use ElixademyWeb, :controller
  use AshAuthentication.Phoenix.Controller
  alias Elixademy.Accounts.UserImpersonation
  ...
  def impersonate(conn, %{"user_id" => user_id}) do
    ...
    if ElixademyWeb.Helpers.is_super_user?(current_user) do
  ...
  defp force_sign_in(conn, current_user_id, perpose \\ "Impersonation") do
    ...
    |> Elixademy.Accounts.User.force_sign_in!(authorize?: false)
  end
