defmodule ElixademyWeb.Router do
  use ElixademyWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {ElixademyWeb.Layouts, :root}
  ...
  scope "/", ElixademyWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {ElixademyWeb.LiveUserAuth, :live_user_optional}
      #
      # If an authenticated user must *not* be present:
      # on_mount {ElixademyWeb.LiveUserAuth, :live_no_user}
  ...
  scope "/", ElixademyWeb do
    ...
    auth_routes AuthController, Elixademy.Accounts.User, path: "/auth"
    ...
    confirm_route Elixademy.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [ElixademyWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Elixademy.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [ElixademyWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
  ...
  # scope "/api", ElixademyWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:Elixademy, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ElixademyWeb.Telemetry
