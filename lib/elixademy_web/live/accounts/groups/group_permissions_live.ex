defmodule ElixademyWeb.Accounts.Groups.GroupPermissionsLive do
  ...
  defp assign_group_permissions(socket) do
    ...
    group_permissions =
      Elixademy.Accounts.GroupPermission
  ...
  defp get_resources(socket) do
    ...
    for domain <- Application.get_env(:Elixademy, :ash_domains) do
