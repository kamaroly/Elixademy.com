defmodule Elixademy.Accounts.Group do
  use Ash.Resource,
  ...
  relationships do
    ...
    # lib/Elixademy/accounts/group.ex
    has_many :permissions, Elixademy.Accounts.GroupPermission do
