defmodule Elixademy.Accounts.User.Actions do
  ...
  actions do
    ...
    update :switch_team_to do
      ...
      validate Elixademy.Accounts.User.Validations.ValidateBelongsToTeam
      change set_attribute(:current_team, arg(:team))
    end
    ...
    create :invite do
      ...
      validate Elixademy.Accounts.User.Validations.ValidateNewToTeam
      manual Elixademy.Accounts.User.Actions.CreateUserIfNotExists
      change Elixademy.Accounts.User.Changes.AddToTeam
    end
    ...
    action :force_sign_in, :map do
      ...
      run Elixademy.Accounts.User.Actions.ForceSignIn
    end
  end
