defmodule Elixademy.Accounts.Team do
  ...
  actions do
    ...
    create :create do
      primary? true
      change Elixademy.Accounts.Team.Changes.AddUserTeam
      change Elixademy.Accounts.Team.Changes.AddTeamOwner
      change Elixademy.Accounts.Team.Changes.SwitchActorTeam
    end
  ...
  relationships do
    belongs_to :owner, Elixademy.Accounts.User do
      source_attribute :owner_user_id
    end

    many_to_many :users, Elixademy.Accounts.User do
