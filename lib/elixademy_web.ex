defmodule ElixademyWeb do
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import ElixademyWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias ElixademyWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ElixademyWeb.Router,
        statics: ElixademyWeb.static_paths()
    end
  end
